...
{
    [DbContext(typeof(GraphTaskDbContext))]
    [Migration("20230404144739_GraphStats")]
    partial class GraphStats
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GraphTask.Graph.Edge", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GraphTask.Graph.Graph", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<double>("AverageNumberOfAdjacentNodes")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("GraphTask.Graph.Edge", b =>
                {
                    b.HasOne("GraphTask.Graph.Graph", null)
                        .WithMany("Edges")
